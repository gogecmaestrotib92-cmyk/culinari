...
export default function VideoPreview() {
  ...
  return (
    <section id="video" className="py-16 md:py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
              ...
              {!isPlaying ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gray-900">
                  <div className="text-center text-white">
                    ...
                    <p className="text-gray-400 mt-2">Ovde bi bio embedovan pravi video</p>
                    <button 
